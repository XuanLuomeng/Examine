...
public class AddUser extends Application {
    ...
    public void start(Stage Ad){
        ...
        //提示信息
        Na.setPromptText("输入姓名");
        Nu.setPromptText("输入号码");
        Ma.setPromptText("输入邮箱");
        //文本框透明化
        ...
        * */
        ...
        Ad.setScene(scene);
        Ad.setResizable(false);//锁定舞台大小//锁定新窗口大小
        Ad.setTitle("联系人信息输入");
        Ad.show();
    }
}
